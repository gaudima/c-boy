...
Emu::Mmu::Mbc3::Mbc3(uint8_t *rom, uint32_t romSize, uint8_t *ram, uint32_t ramSize) :
...
uint8_t Emu::Mmu::Mbc3::rb(uint16_t addr) {
...
void Emu::Mmu::Mbc3::wb(uint16_t addr, uint8_t val) {
